...
function Navbar() {
  ...
  return (
    <div className="nav">
      <div className="left">
        <div className="nadLogo">
          <img className="nadLogo" src="Monad-Logo.webp" alt="Logo" />
        </div>
      ...
      <div className="right">
        ...
        <div className="navItem" onClick={toggleWalletOptions}>
          <Button className="navbtn" children="Connect Wallet" />
          {showWalletOptions && <Card />}
        </div>
      </div>
    </div>
  );
